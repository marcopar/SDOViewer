...
public enum SDO {
    ...
    public static String getDescription(SDO si) {
        switch (si) {
            ...
            case AIA_4500:
                return "<p><strong>AIA 4500 is malfunctioning since December 2013.<br/>Use HMI Intensitygrams instead.</strong></p><p>This channel shows the features that our eyes would see if we dim the Sun's intensely bright light. This wavelength of light is visible to people as blue-indigo, although here it is shown in yellow. Sunspots stand out sharply here, and you can also see that the edge of the Sun appears darker a well-known effect called limb darkening.</p><p><strong>Where:</strong> Photosphere<br /><strong>Wavelength:</strong> 4500 angstroms (0.00000045 m) = Visible (blue-indigo)<br /><strong>Primary ions seen:</strong> Continuum<br /><strong>Characteristic temperature:</strong> 6,000 K (11,000 F)</p>";
